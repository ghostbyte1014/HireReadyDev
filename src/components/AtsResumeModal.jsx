...
export function AtsResumeModal({ onClose, theme }) {
  ...
  // Mobile Sub-Tab Toggle: 'editor' | 'preview'
  const [mobileSubTab, setMobileSubTab] = useState('editor');
    ...
    >
      <div
        style={{
          ...
          border: `1px solid ${isDark ? '#374151' : '#CFC7B0'}`,
          color: isDark ? '#EDE9DE' : '#22262B',
          borderRadius: isMobileScreen ? 8 : 10,
          maxWidth: 1160,
          width: "100%",
          height: isMobileScreen ? "96vh" : "94vh",
          maxHeight: isMobileScreen ? "96vh" : "94vh",
          display: "flex",
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <UserCheck size={isMobileScreen ? 18 : 22} color="#60A5FA" />
            <div>
              <div style={{ fontWeight: 800, fontSize: isMobileScreen ? 13 : 16 }}>
                ATS Single-Column Resume Builder
              </div>
              <div style={{ fontSize: 10, color: "#9CA3AF" }}>
                HireReady Dev &bull; 100% Mobile & Desktop Ready
              </div>
            </div>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            >
              <Download size={13} /> {isMobileScreen ? 'Export PDF' : 'Export ATS PDF'}
            </button>
            <button
              onClick={onClose}
        ...
        <div
          ...
          className="fg-scroll"
        >
          <div style={{ fontSize: 10.5, fontWeight: 800, color: isDark ? '#9CA3AF' : '#5B5A52', display: "flex", alignItems: "center", gap: 4, whiteSpace: "nowrap" }}>
        ...
        {/* MOBILE VIEW SUB-TAB SWITCHER (EDITOR vs PREVIEW) */}
        {isMobileScreen && activeTab === 'template' && (
          <div style={{ display: "flex", background: isDark ? '#111827' : '#E3DECD', padding: 4, borderBottom: `1px solid ${isDark ? '#374151' : '#CFC7B0'}` }}>
            <button
              ...
              style={{
                ...
                borderRadius: 4,
                border: "none",
                background: mobileSubTab === 'editor' ? (isDark ? '#3B82F6' : '#22262B') : 'transparent',
                color: mobileSubTab === 'editor' ? '#FFF' : (isDark ? '#9CA3AF' : '#5B5A52'),
                fontSize: 11.5,
                fontWeight: 700,
                cursor: "pointer",
                display: "flex",
            ...
            >
              <Edit3 size={13} /> Edit Resume Details
            </button>
            <button
              ...
              style={{
                ...
                borderRadius: 4,
                border: "none",
                background: mobileSubTab === 'preview' ? (isDark ? '#3B82F6' : '#22262B') : 'transparent',
                color: mobileSubTab === 'preview' ? '#FFF' : (isDark ? '#9CA3AF' : '#5B5A52'),
                fontSize: 11.5,
                fontWeight: 700,
                cursor: "pointer",
                display: "flex",
            ...
            >
              <Eye size={13} /> Live ATS Preview
            </button>
          </div>
        )}

        {/* MODAL BODY CONTENT */}
        <div style={{ flex: 1, overflowY: "auto", padding: isMobileScreen ? 10 : 20 }}>
          {activeTab === 'template' && (
            <div style={{ display: isMobileScreen ? "block" : "grid", gridTemplateColumns: isMobileScreen ? "1fr" : "470px 1fr", gap: 20 }}>
              {/* LEFT COLUMN: EDITABLE DYNAMIC CONTROLS & FORM */}
              {(!isMobileScreen || mobileSubTab === 'editor') && (
                <div className="fg-scroll" style={{ maxHeight: isMobileScreen ? "none" : "74vh", overflowY: isMobileScreen ? "visible" : "auto", paddingRight: isMobileScreen ? 0 : 8 }}>
              ...
              {(!isMobileScreen || mobileSubTab === 'preview') && (
                <div className="fg-scroll" style={{ maxHeight: isMobileScreen ? "none" : "74vh", overflowY: "auto", background: "#64748B", padding: isMobileScreen ? 10 : 20, borderRadius: 6 }}>
                  <div
                    id="ats-resume-print-canvas"
                    style={{
                      background: "#FFFFFF",
                      color: "#111827",
                      padding: isMobileScreen ? "20px 18px" : (selectedTemplate === 'compact' ? "32px 36px" : "40px 44px"),
                      borderRadius: 2,
                  ...
                  >
                    ...
                    >
                      <h1
                        style={{
                          fontSize: isMobileScreen ? "16pt" : "20pt",
                          fontWeight: "bold",
                      ...
                      <div style={{ fontSize: isMobileScreen ? "10pt" : "11pt", fontWeight: "bold", color: "#374151", marginTop: 4 }}>
          ...
          {activeTab === 'guidance' && (
            <div style={{ maxWidth: 800, margin: "0 auto", lineHeight: 1.6 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: isMobileScreen ? "1fr" : "1fr 1fr", gap: 14, marginBottom: 20 }}>
                {/* 1-COLUMN PROS */}
